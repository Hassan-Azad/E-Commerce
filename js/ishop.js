// cart
let icartIcon = document.querySelector("#cart-icon");
let icart = document.querySelector(".my-cart");
let icloseCart = document.querySelector(".close-cart");

// open acrt
icartIcon.onclick = () => {
  icart.classList.add("active");
};
// close cart
icloseCart.onclick = () => {
  icart.classList.remove("active");
};
